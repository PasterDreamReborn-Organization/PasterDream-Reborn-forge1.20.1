...
public class ModBlockEntities
{
    ...
    public static final RegistryObject<BlockEntityType<WindMoorDeskBlockEntity>> WIND_MOOR_DESK = BLOCK_ENTITIES.register("wind_moot_desk", () -> BlockEntityType.Builder.of(WindMoorDeskBlockEntity::new, ModBlocks.WIND_MOOR_DESK.get()).build(null));
    ...
    public static final RegistryObject<BlockEntityType<WindKnightAltarBlockEntity>> BREAK_WIND_KNIGHT_ALTAR = BLOCK_ENTITIES.register("break_wind_knight_altar", () -> BlockEntityType.Builder.of(WindKnightAltarBlockEntity::new, ModBlocks.BREAK_WIND_KNIGHT_ALTAR.get()).build(null));
