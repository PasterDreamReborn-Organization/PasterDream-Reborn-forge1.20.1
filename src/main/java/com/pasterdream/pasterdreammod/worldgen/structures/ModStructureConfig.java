...
public class ModStructureConfig
{
    ...
    public static List<StructureGenerationConfig> getStructureConfig()
    {
        ...
        STRUCTURES.add(new StructureGenerationConfig("pasterdream:lost_windknight_ruins", "pasterdream:wind_moor_archipelago", "surface_structures", "none", "very_biased_to_bottom", 100, 120, "WORLD_SURFACE_WG", 64, 1, false, "rigid", "minecraft:empty", 1, 42, 25, 1344649511, 1, null, false));
