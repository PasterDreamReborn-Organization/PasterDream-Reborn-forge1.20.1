...
public class ModStructureConfig
{
    ...
    public static List<StructureGenerationConfig> getStructureConfig()
    {
        ...
        STRUCTURES.add(new StructureGenerationConfig("pasterdream:pinkagaric_house",      "pasterdream:can_pinkagaric_house_spawn_biome", "surface_structures", "none", -3, "WORLD_SURFACE_WG", 1, 1, false, "rigid", "minecraft:empty", 1, 26, 8, 18365492, 10, "dyedream_structures"));
