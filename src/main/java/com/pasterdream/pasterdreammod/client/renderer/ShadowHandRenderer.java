...
import com.pasterdream.pasterdreammod.client.model.ShadowHandModel;
...
public class ShadowHandRenderer extends GeoEntityRenderer<ShadowHandEntity> {
    ...
    @Override
    public RenderType getRenderType(ShadowHandEntity animatable, ResourceLocation texture,
                                     @Nullable MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, ShadowHandEntity entity, BakedGeoModel model,
