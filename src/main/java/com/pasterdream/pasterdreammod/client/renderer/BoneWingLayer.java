...
public class BoneWingLayer extends GeoRenderLayer<BoneWingEntity> {
    private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(PasterDreamMod.MOD_ID, "textures/entities/bone_wing_light.png");
    ...
    @Override
    public void render(PoseStack poseStack, BoneWingEntity animatable, BakedGeoModel bakedModel, RenderType renderType,
