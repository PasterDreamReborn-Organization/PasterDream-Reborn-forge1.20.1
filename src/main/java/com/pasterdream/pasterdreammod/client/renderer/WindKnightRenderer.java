...
import com.pasterdream.pasterdreammod.client.model.WindKnightModel;
...
public class WindKnightRenderer extends GeoEntityRenderer<WindKnightEntity> {
    ...
    @Override
    public RenderType getRenderType(WindKnightEntity animatable, ResourceLocation texture,
                                    @Nullable MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, WindKnightEntity entity, BakedGeoModel model,
