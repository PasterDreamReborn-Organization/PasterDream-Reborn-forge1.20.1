...
public class ShadowErosionAxeItem extends AxeItem implements ShadowErosionTool {

    public ShadowErosionAxeItem(Tier tier, float damage, float speed, Properties properties) {
