...
public class ShadowErosionPickaxeItem extends PickaxeItem implements ShadowErosionTool {

    public ShadowErosionPickaxeItem(Tier tier, int damage, float speed, Properties properties) {
