...
public class ShadowErosionHoeItem extends HoeItem implements ShadowErosionTool {

    public ShadowErosionHoeItem(Tier tier, int damage, float speed, Properties properties) {
