...
public class ShadowErosionShovelItem extends ShovelItem implements ShadowErosionTool {

    public ShadowErosionShovelItem(Tier tier, float damage, float speed, Properties properties) {
