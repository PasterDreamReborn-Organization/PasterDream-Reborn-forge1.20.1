...
public class ModBlockLootTablesProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        buildingFamily(new BuildingBlockFamily(ModBlocks.WHITE_SANDSTONE, ModBlocks.WHITE_SANDSTONE_STAIRS, ModBlocks.WHITE_SANDSTONE_SLAB, ModBlocks.WHITE_SANDSTONE_WALL));
        buildingFamily(new BuildingBlockFamily(ModBlocks.CUT_WHITE_SANDSTONE, ModBlocks.CUT_WHITE_SANDSTONE_STAIRS, ModBlocks.CUT_WHITE_SANDSTONE_SLAB, ModBlocks.CUT_WHITE_SANDSTONE_WALL));
        buildingFamily(new BuildingBlockFamily(ModBlocks.SMOOTH_WHITE_SANDSTONE, ModBlocks.SMOOTH_WHITE_SANDSTONE_STAIRS, ModBlocks.SMOOTH_WHITE_SANDSTONE_SLAB, ModBlocks.SMOOTH_WHITE_SANDSTONE_WALL));
        ...
        dropSelf(ModBlocks.DYEDREAM_WORLD_LEAPSTONE.get());
        dropNone(ModBlocks.DYEDREAM_WORLD_PORTAL.get());
