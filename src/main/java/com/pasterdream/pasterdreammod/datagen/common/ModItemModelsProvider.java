...
public class ModItemModelsProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        wallItem(ModBlocks.DYEDREAM_SANDSTONE_WALL, ModBlocks.DYEDREAM_SANDSTONE);
        wallItem(ModBlocks.CUT_DYEDREAM_SANDSTONE_WALL, ModBlocks.CUT_DYEDREAM_SANDSTONE);
