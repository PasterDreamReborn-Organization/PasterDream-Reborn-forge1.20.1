...
public class ModZhCnLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ModBlocks.SLUMBER_PALM_BLOCK.get(), "眠椰块");
        ...
        add(ModBlocks.DYEDREAM_SANDSTONE.get(), "染梦砂岩");
        add(ModBlocks.DYEDREAM_SANDSTONE_STAIRS.get(), "染梦砂岩楼梯");
        add(ModBlocks.DYEDREAM_SANDSTONE_SLAB.get(), "染梦砂岩台阶");
        add(ModBlocks.DYEDREAM_SANDSTONE_WALL.get(), "染梦砂岩墙");
        add(ModBlocks.CUT_DYEDREAM_SANDSTONE.get(), "切制染梦砂岩");
        add(ModBlocks.CUT_DYEDREAM_SANDSTONE_STAIRS.get(), "切制染梦砂岩楼梯");
        add(ModBlocks.CUT_DYEDREAM_SANDSTONE_SLAB.get(), "切制染梦砂岩台阶");
        add(ModBlocks.CUT_DYEDREAM_SANDSTONE_WALL.get(), "切制染梦砂岩墙");
        add(ModBlocks.CHISELED_DYEDREAM_SANDSTONE.get(), "雕纹染梦砂岩");
        add(ModBlocks.SMOOTH_DYEDREAM_SANDSTONE.get(), "平滑染梦砂岩");
        add(ModBlocks.SMOOTH_DYEDREAM_SANDSTONE_STAIRS.get(), "平滑染梦砂岩楼梯");
        add(ModBlocks.SMOOTH_DYEDREAM_SANDSTONE_SLAB.get(), "平滑染梦砂岩台阶");
        add(ModBlocks.SMOOTH_DYEDREAM_SANDSTONE_WALL.get(), "平滑染梦砂岩墙");
        ...
        add(ModBlocks.WHITE_SANDSTONE.get(), "白砂岩");
        add(ModBlocks.WHITE_SANDSTONE_STAIRS.get(), "白砂岩楼梯");
        add(ModBlocks.WHITE_SANDSTONE_SLAB.get(), "白砂岩台阶");
        add(ModBlocks.WHITE_SANDSTONE_WALL.get(), "白砂岩墙");
        add(ModBlocks.CUT_WHITE_SANDSTONE.get(), "切制白砂岩");
        add(ModBlocks.CUT_WHITE_SANDSTONE_STAIRS.get(), "切制白砂岩楼梯");
        add(ModBlocks.CUT_WHITE_SANDSTONE_SLAB.get(), "切制白砂岩台阶");
        add(ModBlocks.CUT_WHITE_SANDSTONE_WALL.get(), "切制白砂岩墙");
        add(ModBlocks.CHISELED_WHITE_SANDSTONE.get(), "雕纹白砂岩");
        add(ModBlocks.SMOOTH_WHITE_SANDSTONE.get(), "平滑白砂岩");
        add(ModBlocks.SMOOTH_WHITE_SANDSTONE_STAIRS.get(), "平滑白砂岩楼梯");
        add(ModBlocks.SMOOTH_WHITE_SANDSTONE_SLAB.get(), "平滑白砂岩台阶");
        add(ModBlocks.SMOOTH_WHITE_SANDSTONE_WALL.get(), "平滑白砂岩墙");
        ...
        add("tooltip.pasterdream.windwreathed_thunder_spear.desc1", "§7▪ §9普通右键蓄力突进（基础冷却 3 秒、消耗 1 融梦能量）；激流附魔增强冲量，每级 +1 秒冷却、+1.0 能量消耗");
        ...
        add("tooltip.pasterdream.soul_gem_of_akizuki_ayane.6", "§7▪ §4融梦能量消耗翻倍");
        add("tooltip.pasterdream.soul_gem_of_akizuki_ayane.7", "§7▪ §4融梦能量低于 30 时，受到的伤害翻倍");
